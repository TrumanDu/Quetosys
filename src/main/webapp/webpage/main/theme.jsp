...
<head>
	...
	<link href="${webRoot}/static/printShou.css" rel="stylesheet"type="text/css" media="print"/> 
	<%-- <link href="${webRoot}/static/admin/pages/bootstrap-modal-bs3patch.css" rel="stylesheet" type="text/css"/>
	<link href="${webRoot}/static/admin/pages/bootstrap-modal.css" rel="stylesheet" type="text/css"/> --%>
	<!-- END THEME STYLES -->
	<style type="text/css">
...
<!-- END FOOTER -->	
	...
	<script src="${webRoot}/static/toUpper.js" type="text/javascript"></script>
	
	<script src="${webRoot}/static/admin/pages/jquery.jqprint-0.3.js"></script>
